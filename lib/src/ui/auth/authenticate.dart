  ...
  Future<void> _performLogin() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (authService.isAuthenticated && mounted) {
        ...
        // Option 1: Replace current route (user can't go back to login)
        Navigator.of(context).pushReplacementNamed(
          MyHomePage.routeName,
        ); // Assuming MyHomePage has a routeName
        // Option 2: Push new route (user can go back, maybe not desired for login)
    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
        // appBar: AppBar( // Optional: if you want an AppBar
